...
Требуется написать небольшой модуль, который будет заниматься фильтрацией набора перелётов согласно различным правилам. 
...
В папке testdata содержатся упрощённые модельные классы и фабрика для получения тестовых образцов. 
